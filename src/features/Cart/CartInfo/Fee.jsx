...
const Fee = ({ addressSelected }) => {
  const cartState = useSelector(state => state.cart);
  const { data: shippingFee, isLoading } = useGetShippingFeeQuery({
    fromDistrictId: addressSelected.districtId,
    fromWardCode: addressSelected.wardCode,
  });
  if (isLoading) {
    return <p>Loading</p>;
  }
